    ...
    <section
      ...
      style={{
        background: `
          ...
          linear-gradient(135deg, #caf0a0 0%, #78cc30 60%, #3d8010 100%)
        `,
      }}
    >
      {/* Decorative panel */}
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse at 55% 35%, #edf9d4 0 14%, transparent 15%),
            linear-gradient(180deg, #dcf5bc 30%, #96d850 70%, #3d8010 100%)
          `,
