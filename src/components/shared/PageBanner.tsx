    ...
    <section
      ...
      style={{
        background: `
          ...
          linear-gradient(135deg, #a8d878 0%, #60b520 45%, #007fda 100%)
        `,
      }}
    >
      {/* Decorative panel */}
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse at 55% 35%, #e0f4ff 0 14%, transparent 15%),
            linear-gradient(180deg, #dcf5bc 30%, #60b520 60%, #007fda 100%)
          `,
