...
const row1 = [
  { name: "Dr. Adnan Shaikh", role: "Consultant Physiotherapist", sub: "Co-Founder & Director", grad: "from-[#0070c4] to-[#3399e0]" },
  { name: "Waseem Khan", role: "Co-Founder & CEO", sub: "", grad: "from-[#005aa0] to-[#007fda]" },
  { name: "Dr. Sayeda Nimra", role: "Clinical Physiotherapist", sub: "", grad: "from-[#007fda] to-[#66b3e8]" },
  { name: "Dr. Alfiya Khan PT", role: "Clinical Physiotherapist", sub: "", grad: "from-[#0068b8] to-[#99caf0]" },
];

const row2 = [
  { name: "Dr. Muqit PT", role: "Clinical Physiotherapist", grad: "from-[#0070c4] to-[#3399e0]" },
  { name: "Dr. Aarthi Chauhan PT", role: "Clinical Physiotherapist", grad: "from-[#007fda] to-[#66b3e8]" },
  { name: "Dr. Saleena PT", role: "Clinical Physiotherapist", grad: "from-[#0068b8] to-[#99caf0]" },
];
        ...
        <div className="max-w-[1180px] mx-auto px-7">
            ...
            {row1.map(({ name, role, sub, grad }) => (
              <div key={name} className="bg-white border border-brand-line rounded-[16px] p-7 pb-[26px] text-center hover:-translate-y-1 hover:shadow-[0_22px_44px_-22px_rgba(38,43,21,0.25)] transition-[transform,box-shadow] duration-200">
                <div className={`w-[150px] h-[150px] rounded-full mx-auto mb-[18px] relative overflow-hidden bg-gradient-to-b ${grad} shadow-[inset_0_-16px_24px_rgba(38,43,21,0.2)]`}>
                  <div className="absolute top-[18%] left-[30%] w-[40%] h-[40%] rounded-full" style={{ background: "linear-gradient(180deg, #cce3f8, #66b3e8)" }} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-7 max-w-[880px] mx-auto">
            {row2.map(({ name, role, grad }, i) => {
              const portraitGrads = ["from-[#0070c4] to-[#3399e0]", "from-[#007fda] to-[#66b3e8]", "from-[#0068b8] to-[#99caf0]"];
              return (
