...
const posts = [
  {
    grad: "from-[#4a8a15] to-[#8fd41a]",   // green
    label: "Chronic Pain",
    date: "May 24, 2026",
  ...
  {
    grad: "from-[#3a7a12] to-[#73c01a]",   // green
    label: "Neck Pain",
    date: "May 17, 2026",
  ...
  {
    grad: "from-[#3a7a12] to-[#8fd41a]",   // green
    label: "Back Pain",
    date: "May 17, 2026",
  ...
  {
    grad: "from-[#73c01a] to-[#8fd41a]",   // green
    label: "Clinic",
    date: "May 10, 2026",
...
const latestPosts = [
  { grad: "from-[#73c01a] to-[#8fd41a]",  title: "Can Physiotherapy Cure Chronic Pain? The Blueprint for Long-Term Relief", date: "May 24, 2026" },
  { grad: "from-[#4a8a15] to-[#a3d94a]",  title: "Neck Pain and Cervical Spondylosis: How Physiotherapy Gives You Lasting Relief", date: "May 17, 2026" },
  { grad: "from-[#4a8a15] to-[#8fd41a]",  title: "7 Proven Physiotherapy Treatments for Lower Back Pain", date: "May 17, 2026" },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.7fr_1fr] gap-14">
            ...
            <div>
              {posts.map(({ grad, label, date, title, excerpt }) => (
                <article key={title} className="border-b border-brand-line pb-9 mb-9 last:border-b-0 last:mb-0">
                  ...
                  <a href="#" className="inline-flex items-center gap-[6px] bg-brand-blue text-white px-4 py-2 rounded-full text-[12px] font-semibold hover:opacity-90 transition-opacity">
                    Read More
            ...
            <aside>
              ...
              <div className="border border-brand-line rounded-full px-[6px] py-[6px] flex gap-2 mb-7">
                ...
                <button className="bg-brand-blue text-white border-0 cursor-pointer px-[18px] py-2 rounded-full text-[12px] font-semibold hover:opacity-90 transition-opacity">Search</button>
              </div>
              ...
              <div className="bg-white border border-brand-line rounded-[14px] overflow-hidden">
                ...
                <div className="p-[16px_20px]">
                  ...
                  <div className="flex gap-[6px] items-center border border-brand-line rounded-full p-1">
                    ...
                    <button className="w-[30px] h-[30px] rounded-full bg-brand-blue text-white border-0 cursor-pointer grid place-items-center hover:opacity-90 transition-opacity flex-shrink-0">
