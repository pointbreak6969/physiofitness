        ...
        <div className="max-w-[1180px] mx-auto px-7">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-12">
            <div className="flex items-center gap-6">
              <div className="w-20 h-20 rounded-full bg-brand-blue text-white grid place-items-center flex-shrink-0">
          ...
          <div
            ...
            style={{
              background: `
                repeating-linear-gradient(0deg, transparent 0 60px, rgba(115,192,26,.08) 60px 61px),
                repeating-linear-gradient(90deg, transparent 0 60px, rgba(115,192,26,.08) 60px 61px),
                linear-gradient(135deg, #f0fae0, #d6eeb0)
              `,
            }}
          >
            {/* <div
